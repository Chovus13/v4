...
# Postavke za zidove
<<<<<<< HEAD
WALL_RANGE_SPREAD = float(os.getenv('WALL_RANGE_SPREAD', 0.0010))  # povecao na 0.0010, a bilo 0.0005
MIN_WALL_VOLUME = float(os.getenv('MIN_WALL_VOLUME', 10.0))  # smanjio na 5 , bilo 10
=======
WALL_RANGE_SPREAD = float(os.getenv('WALL_RANGE_SPREAD', 0.000015))  # povecao na 0.0010, a bilo 0.0005
MIN_WALL_VOLUME = float(os.getenv('MIN_WALL_VOLUME', 70))  # smanjio na 5 , bilo 10
